        ...
        <main className="container mx-auto px-6 pt-32 pb-16 flex-1">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-2xl font-semibold text-green-700 mb-2">{data.headmaster}</h2>
          ...
          <section className="mt-16 grid md:grid-cols-2 gap-8 text-center">
            ...
            >
              ...
              <p className="text-gray-600 mt-1">Guru berpengalaman dan penyayang anak.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 mt-1">Anak-anak ceria dan aktif setiap hari.</p>
            </motion.div>
          </section>
