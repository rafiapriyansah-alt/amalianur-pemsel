  ...
  return (
    <>
      <Head>
        ...
        {/* TAMBAHKAN VIEWPORT META TAG YANG LENGKAP */}
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-b from-green-50 to-white">
        ...
        <main className="w-full mx-auto px-3 sm:px-4 md:px-6 pt-24 md:pt-28 pb-12 md:pb-16 flex-1 overflow-x-hidden">
          ...
          {/* Kepala Sekolah - FIXED RESPONSIVE */}
          ...
          {/* Program Unggulan - FIXED RESPONSIVE */}
          ...
          {/* Ekstrakurikuler - FIXED RESPONSIVE */}
          ...
          {/* GALERI - FIXED COMPLETELY RESPONSIVE */}
          <section className="mt-8 md:mt-12 lg:mt-16 w-full max-w-6xl mx-auto">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
